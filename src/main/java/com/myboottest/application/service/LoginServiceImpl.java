package com.myboottest.application.service;
...
import com.myboottest.application.dao.MemberAuthDAOImpl;
...
public class LoginServiceImpl implements UserDetailsService{
	...
	@Override
	public UserDetails loadUserByUsername(String userid) throws UsernameNotFoundException { // 매개변수로 ID 하나만. 
		...
		if(userinfo == null){
			...
			Collection<SimpleGrantedAuthority> roles = new ArrayList<SimpleGrantedAuthority>(); // 권한체크를 위한 것들을 가진 Collection 
