package com.myboottest.application.config;
...
import com.myboottest.application.service.LoginServiceImpl;
...
public class MultiSecurityConfig {
    ...
    public void configureGlobal(AuthenticationManagerBuilder auth) throws Exception {
        ...
        auth.userDetailsService(loginservice).passwordEncoder(shapasswordencoder); // 커스터마이징 - loginservice 넣어주는 부분 
    }
